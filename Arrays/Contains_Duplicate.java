...
// Difficulty: Easy
// Approach: I used a HashSet to track numbers already seen. While iterating through the array, if adding a number
// to the set failed, it meant the number was already present, so I returned true immediately. If the loop completed
